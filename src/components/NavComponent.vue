<template>
    ...
    <div id="nav" v-if="displayNav">
        <svg v-if="mobile" class="clickable glass bread" @click="() => hideNav=true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M14.9999 9L8.99994 15M9.00006 9L10.5 10.5M15.0001 15L12 12M20 16C20 18.2091 18.2091 20 16 20H8C5.79086 20 4 18.2091 4 16V8C4 5.79086 5.79086 4 8 4H16C18.2091 4 20 5.79086 20 8V12" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
        <div id="siteLinks" class="glass">            
        ...
        <a class="glass" href="assets/apprentissages.pdf" style="margin: 10px; color: white;">PPP</a>
    </div>
</template>
